...
Benchmark scripts for comparing single-cell RNA-seq and single-cell ATAC-seq technologies. The workflows summarize quality metrics, capture efficiency, biological signal, and scoring results, then export tables and publication-style figures.
...
Use a scientific Python environment with:
